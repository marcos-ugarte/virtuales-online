...
export interface Race {
   ...
   * ("1","2","3"), each split keyed by rank ("1","2") → the dog at that rank.
   * Drives the ported RaceIntervalsDog leaders box. Arrives with gameResult,
   * merged onto the Race like `finish`.
   */
