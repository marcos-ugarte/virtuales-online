...
const STRINGS: Record<Lang, Dict> = {
  en: {
    ...
    'rp.tabTicket': 'Tickets',
    'rp.close': 'Close',
    'stakePicker.title': 'Amount',
    'stakePicker.other': 'Other amount',
    'stakePicker.add': 'Add',
    'stakePicker.update': 'Update',
    'forecast.toggle': 'Forecast odds',
    'forecast.title': 'Forecast (1st → 2nd)',
    'forecast.legend': '1st ↓ · 2nd →',
    'forecast.step1': 'Pick 1st place',
    'forecast.step2': 'Pick 2nd place',
  ...
  es: {
    ...
    'rp.tabTicket': 'Tickets',
    'rp.close': 'Cerrar',
    'stakePicker.title': 'Importe',
    'stakePicker.other': 'Otro importe',
    'stakePicker.add': 'Añadir',
    'stakePicker.update': 'Actualizar',
    'forecast.toggle': 'Cuotas forecast',
    'forecast.title': 'Forecast (1.º → 2.º)',
    'forecast.legend': '1.º ↓ · 2.º →',
    'forecast.step1': 'Elige 1.º lugar',
    'forecast.step2': 'Elige 2.º lugar',
