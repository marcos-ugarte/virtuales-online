...
export class FadeVideoDog extends Group {
  ...
  public onLayout() {
    ...
    const greenColor = this.gameType === "dog8" ? 0x339e6a : 0x345cb4;
    this.createRound(this.whiteBig, texRadius100, this.width * 0.5, this.height, 0xffffff, 1.0);
    this.createRound(this.greenBig, texRadius100, this.width * 0.5, this.height, greenColor, 1.0);

    this.createBar(this.transparentBar, this.width * 0.2, this.height * 1.04, 0x02351c, 0.3);
    this.createBar(this.transparentBar2, this.width * 0.4, this.height * 0.7, 0x02351c, 0.3);

    this.createRound(this.greenBar, texRadius30, this.width * 0.5, this.height * 0.3, greenColor, 1.0);
    this.createBar(this.redBar, this.width * 0.4, this.height * 0.2, 0xff0000, 1.0);
    this.createBar(this.whiteBar, this.width * 0.4, this.height * 0.2, 0xffffff, 1.0);
    this.createBar(this.redBar2, this.width * 0.4, this.height * 0.2, 0xff0000, 1.0);
